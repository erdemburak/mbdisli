  ...
  const features = [
    {
      ...
      description: language === 'tr'
        ? 'En kaliteli malzemelerden üretilen kesiciler'
        : 'Cutters produced from the highest quality materials'
    },
    {
      icon: <FaTools className="w-8 h-8 text-primary-600" />,
      title: language === 'tr' ? 'Uzun Ömürlü' : 'Long Lasting',
      description: language === 'tr'
        ? 'Yüksek dayanıklılık ve uzun kullanım ömrü'
        : 'High durability and long service life'
    },
    {
      icon: <FaIndustry className="w-8 h-8 text-primary-600" />,
      title: language === 'tr' ? 'Geniş Ürün Yelpazesi' : 'Wide Product Range',
      description: language === 'tr'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          {t.products.categories.cutters}
        </h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          {language === 'tr'
            ? 'Profesyonel dişli kesici takımlar ile hassas ve verimli üretim'
            : 'Precise and efficient production with professional gear cutting tools'}
        </p>
      </motion.div>
